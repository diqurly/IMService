 ...
 *
 */
public class CsServiceHandler extends DhandlerInterface{

	private ConnectManage<Channel> connectMange;
	private BlockingQueue<Packet> queue;

	public CsServiceHandler(ConnectManage<Channel> connectMange, BlockingQueue<Packet> queue) {
	...
	public DhandlerInterface newHandler() {
		// TODO Auto-generated method stub
		return new CsServiceHandler(connectMange,queue);
	}
